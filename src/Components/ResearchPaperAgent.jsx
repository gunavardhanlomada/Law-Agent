...
const startPapersSession = () => {
  const res = axios.post(`${API_BASE}/papers/start`);
  return res.data;
};

const uploadPapers = (sessionId, files) => {
  ...
  const res = axios.post(`${API_BASE}/papers/upload`, formData, {
    headers: { "Content-Type": "multipart/form-data" },
  });
  return res.data;
};

const sendPapersMessage = (sessionId, query) => {
  const res = axios.post(`${API_BASE}/papers/message`, {
